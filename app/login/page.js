    ...
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm border border-slate-300 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-60 transition-colors flex justify-center items-center gap-2"
        >
